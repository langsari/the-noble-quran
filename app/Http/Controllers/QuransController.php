...
class QuransController extends Controller
{
    ...
    public function homePageAntology() {
        $datasurahs = Datasurah::all();
            return view('quran.home', [
                'datasurahs' => $datasurahs
            ]);
    ...
    public function antology($id) {
        $anotologys = Datasurah::with('antology')->find($id);
        return view('quran.antology', compact('anotologys'));
    }

    public function holyQuran() {
        $datasurahs = Datasurah::all();
