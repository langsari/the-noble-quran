...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); ///Surah Api
  ...
  fetch("http://api.alquran.cloud/v1/meta").then(function (response) {
    ...
    SurahsTitels.forEach(function (title, index) {
      title.addEventListener('click', function () {
        fetch("http://api.alquran.cloud/v1/surah/".concat(index + 1)).then(function (response) {
          return response.json();
        }).then(function (data) {
          ...
          Ayat.forEach(function (aya) {
            ...
            AyatContainer.innerHTML += "<p>(".concat(aya.numberInSurah, ") - ").concat(aya.text, "</p> ");
          });
        });
      });
    });
