...
<head>
  ...
  <!---->
   ...
   <script src="<?php echo e(url('js/runtimeapplication.js')); ?> defer" data-turbolinks-track="reload" defer="defer"></script>
    
      <script src="<?php echo e(url('js/vendorapplication.js')); ?>" data-turbolinks-track="reload" defer="defer"></script>   
    
    <script src="<?php echo e(url('js/application.chunk.js')); ?>" data-turbolinks-track="reload" defer="defer"></script>   
...
<header>     <?php echo $__env->yieldContent('header-content'); ?>         </header>
    ...
    <?php echo $__env->yieldContent('f1'); ?>


  
</body>

</html><?php /**PATH C:\xampp\htdocs\Quran-website\resources\views/main.blade.php ENDPATH**/ ?>