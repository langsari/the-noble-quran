...
<a class="active" href="{{ route('homeuser') }}">Al-Quran</a>
  <a href="{{ route('tafseer_homeuser') }}">Tafsir</a>
  <a href="{{ route('notes.index')}}">Your note</a>
  <a href="{{ route('logout') }}"
...
<div style = background-color:#B3B6B7; class=" row text-center ">
      <!-- Header -->
