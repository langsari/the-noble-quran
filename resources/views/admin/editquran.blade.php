                    ...
                    <div class="col-lg-12">
                      <div class="p-5">
                        ...
                        <form class="form-group text-right">
                          ...
                          <div class="form row">
                            <div class="col-sm-2">
                              <span class="h7 text-gray-900 mb-4 form-text">Name Surah :</span>
                            </div>
                            <div class="col-sm-4">
                              <input class="form-control" id="staff_name" name="staff_name"  type="text" value="อัล-ฟาติหะฮฺ" readonly autocomplete="off">
                            </div>
                            <div class="col-sm-2">
                              <span class="h7 text-gray-900 mb-4 form-text">Ayah No. :</span>
                            </div>
                            <div class="col-sm-4">
...
<!-- 
                          <div class="form-group row">
                            <div class="col-sm-2">
                              <span class="h7 text-gray-900 mb-4 form-text">Level :</span>
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-2">
                              <span class="h7 text-gray-900 mb-4 form-text">Agency :</span>
                            </div>
                            <div class="col-sm-4">
                          ...
                          <div class="form-group row">
                            <div class="col-sm-2">
                              <span class="h7 text-gray-900 mb-4 form-text">Quran :</span>
                            </div>
                            <div class="col-sm-10">
                          ...
                          <div class="form-group row">
                            <div class="col-sm-2">
                              <span class="h7 text-gray-900 mb-4 form-text">Translate :</span>
                            </div>
                            <div class="col-sm-10">
                          ...
                          <div class ="col-md-12">
                          <a class="btn btn-secondary" href="{{ route('staffhome') }}">Save</a>
                          <a class="btn btn-secondary" href="{{ route('staffhome') }}">Cancle</a>
                         </div>
