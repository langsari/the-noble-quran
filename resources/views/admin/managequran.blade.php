             ...
             <!-- dd{{$arabics}} -->
                @foreach($arabics->arabic as $arabic ) 
                    <tr>
                        ...
                        <td>
                       <a href="{{ route('editquran',$datasurah) }}" class="btn btn-info">See</a>
                    ...
                    <div class="col-lg-12">
                      <div class="p-5">
                        ...
                        <form class="form-group text-right">
                          ...
                          <div class="form row">
                            <div class="col-sm-2">
                              <span class="h7 text-gray-900 mb-4 form-text">Surah Name :</span>
                            </div>
                            <div class="col-sm-4">
                              <input class="form-control" id="{{$arabics->id}}" name="th_name"  type="text" value="{{$arabics->th_name}}" readonly autocomplete="off">
                            </div>
                            <div class="col-sm-2">
                              <span class="h7 text-gray-900 mb-4 form-text">No. Ayat :</span>
                            </div>
                            <div class="col-sm-4">
                          ...
                          <div class ="col-md-12">
                          <a class="btn btn-secondary" href="{{ route('adminhome') }}">Save</a>
                          <a class="btn btn-secondary" href="{{ route('adminhome') }}">Cancle</a>
                         </div>
