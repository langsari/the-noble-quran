...
<div style = background-color:#D4D4D4; class="row  text-center ">


      @foreach($datasurahs as $datasurah)     
<div class="col-sm-3">
 <a href="{{ route('thai.index') }}">
  <button style= "height: 90px; width:200px; 
  margin-top: 30px;
  margin-right: 10px;
  margin-left: 10px;
  margin-bottom: 10px;"  
  type="buttom" class="btn btn-outline-dark" >
