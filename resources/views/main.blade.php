...
<img src="\QuranUserInterfaceExperience\unnamed.jpg" alt="HTML5 Icon" style="width:128px;height:128px;">
...
<div id="ilham">
          ...
          <br>
          <br>
          <div class="mt-3 p-5  text-white rounded" style="background-color: #2c5854;">
     ...
     <div class="container"> 
          ...
          <div class="row text-center mt-4">
               <div class="col-sm">
                    ...
                    <a href="Al-fatihah.html"><button style="height: 120px; width:320px;"  type="buttom" class="btn btn-outline-info"><span>Maryam</span> (Mary)
