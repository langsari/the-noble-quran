...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="#band" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Tafseer</a>
    <a href="#tour" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Register</a>
    <a href="#tour" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Log in</a>
    <a href="#contact" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Ontology</a>
    <a href="#tour" class="w3-bar-item w3-button w3-padding-large w3-hide-small">The Holy Quran</a>
