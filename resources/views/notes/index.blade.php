...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  ...
  @if (Auth::user()->is_admin=='1')
    <li class="nav-item">
      <a class="nav-link" href="{{ route('thai.index') }}">Manage Al-quran</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="{{ route('qurantafseers.index') }}">Manage Al-quran tafsir</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="{{ route('tafseers.index') }}">Manage video Al-quran</a>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link" href="{{ route('managenote') }}">Manage notes</a>
    </li> 
...
<!-- <a href="javascript:history.back()" class="btn btn-warning">กลับไปหน้าซูเราะห์</a> -->
          ...
          <a href ="javascript:history.back()"  class ="btn btn-dark my-3"> Back </a>
...
<table class="table table-bordered">
 ...
 <tr>
    <th class="font-weight-bold" >At</th>
         ...
         <!-- <form action="{{ route('notes.destroy', $value->id) }}" method="post">
          ...
          <div class="dropdown"> {{-- Dropdown --}}
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown">
                        <li><a class="dropdown-item" href="{{ route('notes.show', $value->id) }}">Watch</a></li> {{-- View --}}
                        <li><a class="dropdown-item" href="{{ route('notes.edit', $value->id) }}">Edit</a></li> {{-- Edit --}}
