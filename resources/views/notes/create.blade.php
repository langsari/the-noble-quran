...
@endif
 ...
 <form action="{{ route('notes.store') }}" method="post">
    @csrf
 <button type="button" class="open-button "  data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Notes</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="exampleModalLabel">Create a note</h4>
      </div>
      <div class="modal-body">
        <form>
         ...
         -->
          ...
          <p class="cautions">*Please login before creating a note.*</p>
        </form>
      </div>
