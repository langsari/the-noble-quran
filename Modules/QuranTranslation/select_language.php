...
<body>
  ...
  <select class="form-control" name="id" id="id">
    ...
    <option value="en_itani.php">English :	Itani</option>
    <option value="en_maududi.php">English : Maududi</option>
    <option value="en_mubarakpuri.php">English :	Mubarakpuri</option>  
    <option value="en_pickthall.php">English :	Pickthall</option>
    <option value="en_qarai.php">English : 	Qarai </option>
    <option value="en_qaribullah.php">English : Qaribullah & Darwish</option>
    <option value="en_sahih.php">English : Saheeh International</option>  
    <option value="en_sarwar.php">English :	Sarwar </option>
    <option value="en_shakir.php">English :	Shakir</option>
    <option value="en_transliteration.php">English : Transliteration</option>
