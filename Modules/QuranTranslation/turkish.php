  ...
  <table>
    <thead>
      <tr>
        ...
        <th width="1">Quran</th>
        <th width="1">Turkish :	Çeviriyazı</th>
      </tr>
      <thead>
      ...
      <tbody>
        ...
        <?php
          if (extract($_GET)) {
            ...
            if (is_numeric($surah)) {
            $sql = "SELECT Arabic.*, Turkish.* FROM Arabic,Turkish WHERE Arabic.index_arabic=Turkish.index_Turkish AND sura_arabic=$surah ORDER BY index_arabic ASC";
            } else if ($surah == "all") {
